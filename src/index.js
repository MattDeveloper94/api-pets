...
import { validarCamposPetsMiddleware } from './middlewares.js';
...
// Criar novo pet 
//POST → /pets
app.post("/pets", [validarCamposPetsMiddleware], (req, res) => {
    try {
        // entrada
...
// PUT → /pets/:id
app.put("/pets/:id", [validarCamposPetsMiddleware], (req, res) => {
    try {
        //entrada
        const { id } = req.params;
        const { nome, idade, raca, nomeTutor } = req.body
